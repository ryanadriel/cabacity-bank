create table tb_account (account_number integer, agency integer not null, balance_initial float(53), id bigserial not null, key_pix varchar(255), name varchar(255), primary key (id));
